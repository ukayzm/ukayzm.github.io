...
웹캠으로 복도나 출입구 등 주요 장소를 찍어보세요. 웹캠 앞을 지나간 사람들의 얼굴이 자동으로 분류됩니다. 누가 언제 지나갔는지 기록을 남길 수 있습니다. 간단한 인공 지능 CCTV 같지 않나요? [Visitor Alarm Telegram Bot](/visitor-alarm-telegram-bot/)에서는 웹캠으로 인식된 사람을 사용자의 텔레그램으로 실시간으로 전송해 주는 텔레그램 봇을 구현하고 방법을 설명합니다.
