...
[Visitor Alarm Telegram Bot](/visitor-alarm-telegram-bot/)에서는 Unknown face classifier를 확장하여, 인식된 사람의 사진을 실시간으로 텔레그램으로 전송하는 방법을 설명합니다. 웹캠을 집의 현관이나 복도 등 주요 장소에 설치해서 방문자나 지나다니는 사람을 실시간으로 모니터링하고, 자신의 스마트폰으로 알람을 받아볼 수 있습니다.
